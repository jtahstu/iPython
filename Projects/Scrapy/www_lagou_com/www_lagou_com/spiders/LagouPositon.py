...
from www_lagou_com.items import LagouItem
...
class LagoupositonSpider(scrapy.Spider):
    ...
    curpage = 1
    cur = 0
    myurl = 'https://www.lagou.com/jobs/positionAjax.json?city=%E4%B8%8A%E6%B5%B7&needAddtionalResult=false&isSchoolJob=0'

    city = u'北京'
    kds = ['PHP']
    # kds = [u'java', 'python', 'PHP', '.NET', 'JavaScript', 'C#', 'C++', 'C', 'VB', 'Dephi', 'Perl', 'Ruby', 'Go', 'ASP',
    #        'Shell']
